...
| `POST`   | /bill/process 							| POST request to mark the bill as processed (update bill status) 			|
| `POST`   | /bill/reject 							| POST request to mark the bill as rejected (update bill status) 			|
|          |										| 																			|
